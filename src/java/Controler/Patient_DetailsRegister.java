 ...
 * @author gulavita
 */
public class Patient_DetailsRegister extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response);
         ...
         if(!email.equals("")||(email!=null)) {
           ...
           out.println("Welcome");
           request.getRequestDispatcher("Patient_DetailsRegisterHMS.jsp").include(request, response);
    ...
    if ("male".equals(Gender)|| "Female".equals(Gender)){
        ...
        int status= DBcon.AddPatient_Details(e);
        if (status>0){
