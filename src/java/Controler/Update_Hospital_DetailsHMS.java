 ...
 * @author gulavita
 */
public class Update_Hospital_DetailsHMS extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
         ...
         if(!email.equals("")||(email!=null)) {
           ...
           request.getRequestDispatcher("GetAll_Hospital_DetailsHMS.jsp").include(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        e.setHospital_Contact_Number(Hospital_Contact_Number);
         ...
         int status= DBcon.UpdateHospital_Details(e);
        if (status>0){
            out.println("Update Hospital Details Successfully");
                RequestDispatcher req = request.getRequestDispatcher("GetAll_Hospital_DetailsHMS.jsp");
                req.include(request, response);
        
        }else{
        out.println("You are not Update Hospital Details Successfully");
                RequestDispatcher req = request.getRequestDispatcher("Update_Hospital_DetailsHMS.jsp");
                req.include(request, response);
